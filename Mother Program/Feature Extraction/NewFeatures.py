...
def attributes():
    ...
    'money_sign_url', 'percentage_url', 'count_tld_url', 'len_url', 'alpha_url', 'timeresponse_url', 'time_domain_activation_url', 'time_domain_expiration_url', 'Hasshortner_URL'
    'dot_host',
...
def count_tld(text):
    ...
    file_path = 'C:\\Users\\Achilles2000\\Desktop\\Data\\Main Files\\Feature Extraction\\files\\tlds.txt'
...
def extract_extension(text):
    ...
    file_path = 'C:\\Users\\Achilles2000\\Desktop\\Data\\Main Files\\Feature Extraction\\files\\extensions.txt'
    file = open(file_path, 'r')
...
def main(urls, dataset):
    with open(dataset, "w") as output:
        ...
        for url in read_file(urls):
            ...
            equal_url, arroba_url, ampersand_url, exclamation_url,
            blank_url, til_url, comma_url, plus_url, asterisk_url, hashtag_url,
            money_sign_url, percentage_url, count_tld_url, len_url,count_alpha_url,timeresponse_url,time_domain_activation_url,time_domain_expiration_url,Hasshortner_URL,
            dot_host,
            hyphe_host, underline_host, bar_host, question_host, equal_host,
            arroba_host, ampersand_host, exclamation_host, blank_host, til_host,
            comma_host, plus_host, asterisk_host, hashtag_host, money_sign_host,
